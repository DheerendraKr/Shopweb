<div class="index">
    <div class="orders">
        <div class="orders_headers"><span class="header_data">Recent Orders</span></div>
        <table class="v_product">
            ...
            <?php foreach ($this->pending_order as $value) {?>
            <tr>
        ...
        <button class="product_button">View All</button>
    </div>
    <div class="orders">
        ...
        <table class="v_product">
            ...
            <?php foreach ($this->all_order as $value) {?>
            <tr>
                <td  class="th1"><?php echo $value['Order_no'];?></td>
                <td class="product_image th2"><img src="<?php echo IMAGES."Product/".$value['Image'];?>" width="60%"height="80px" id="p_img" /><br />
                <?php echo $value['Name']." | ".$value['Brand'];?>
        ...
        <a href="<?php echo URL;?>Admin/All_orders"><button class="product_button">View All</button></a>
    </div>
